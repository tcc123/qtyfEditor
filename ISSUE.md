...
- [done] ff 中的 bug
- [done] ff 中粘贴图片和文字出现问题 https://github.com/huoalong/qtyfEditor/issues/609
...
- [done] 补充 ng 集成的示例 https://github.com/huoalong/qtyfEditor/issues/859
...
- [done] 将禁用编辑器的操作完善到文档中 https://www.kancloud.cn/wangfupeng/qtyfEditor3/368562
...
- [done] 将一些常见 API 开放，写到文档中 https://www.kancloud.cn/wangfupeng/qtyfEditor3/404586
...
- [done] 增加 onfocus 和 onblur （感谢 [hold-baby](https://github.com/hold-baby) 提交的 [PR](https://github.com/huoalong/qtyfEditor/pull/1076)）
...
- [done] 合并 pr [菜单和编辑区域分离 onfocus onblur 失效bug](https://github.com/huoalong/qtyfEditor/pull/1174) ，感谢 [hold-baby](https://github.com/hold-baby) 提供 pr
...
- 合并 pr
- https://github.com/huoalong/qtyfEditor/issues/1445
- https://github.com/huoalong/qtyfEditor/issues/1410
- https://github.com/huoalong/qtyfEditor/issues/1396
- https://github.com/huoalong/qtyfEditor/issues/1358
- https://github.com/huoalong/qtyfEditor/issues/1367
...
- 撤销的兼容性问题（会误伤其他编辑器或者 input textarea 等），考虑用 onchange 记录 undo 和 redo 的内容（但是得考虑直接修改 dom 的情况，如 quote code img list table 菜单）
    - 列表撤销会删除一行？https://github.com/huoalong/qtyfEditor/issues/1131
    - 页面中有 input 等输入标签时，undo redo 会误伤 https://github.com/huoalong/qtyfEditor/issues/1024
    - 两个编辑器 undo 的问题 https://github.com/huoalong/qtyfEditor/issues/1010
    - list undo redo 有问题。选中几行，先设置有序列表，再设置无序列表，然后撤销，就能复现问题
- 粘贴文字的样式问题（可暂时配置 `pasteTextHandle` 自行处理）
    - 先输入文字，再粘贴 excel 表格，样式丢失 https://github.com/huoalong/qtyfEditor/issues/1000
    - IE 11 直接输入文字会空一行在第二行出现内容 https://github.com/huoalong/qtyfEditor/issues/919
    - windows 下 word excel 的粘贴，存在垃圾数据

## 待排期

- 调研 safari、IE 和ff中粘贴图片  https://github.com/huoalong/qtyfEditor/issues/831
