...
UploadImg.prototype = {
    ...
    _alert: function _alert(alertInfo, debugInfo) {
        ...
        if (debug) {
            throw new Error('qtyfEditor: ' + (debugInfo || alertInfo));
        } else {
    ...
    insertLinkImg: function insertLinkImg(link) {
        ...
        img.onerror = function () {
            img = null;
            // 无法成功下载图片
            _this2._alert('插入图片错误', 'qtyfEditor: \u63D2\u5165\u56FE\u7247\u51FA\u9519\uFF0C\u56FE\u7247\u94FE\u63A5\u662F "' + link + '"\uFF0C\u4E0B\u8F7D\u8BE5\u94FE\u63A5\u5931\u8D25');
            return;
        };
...
// 返回
var index = window.qtyfEditor || Editor;
